  ...
  return (
    <>
      ...
      <p>
        ...
        other intellectual property rights related to it, still belong to kyrie.
      </p>
      <p>
        kyrie is committed to ensuring that the app is as useful and efficient
      ...
      <p>
        The yike app stores and processes personal data that you have provided
        ...
        features and it could mean that the yike app won’t work properly or at
        all.
      </p>
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that kyrie will not
        ...
        or provided by your mobile network provider, but kyrie cannot take
      ...
      <p>
        Along the same lines, kyrie cannot always take responsibility for the
        ...
        the Service, kyrie cannot accept responsibility.
      </p>
      <p>
        With respect to kyrie’s responsibility for your use of the app, when
        ...
        it available to you. kyrie accepts no liability for any loss, direct or
      ...
      <p>
        ...
        updates if you want to keep using the app. kyrie does not promise that
        it will always update the app so that it is relevant to you and/or works
        with the Android, iOS &amp; KaiOS version that you have installed on
      ...
      <p>
        ...
        do not hesitate to contact me at a154571896@gmail.com.
      </p>
      <p>
