  ...
  return (
    <div className="mx-auto flex h-full max-w-prose flex-col gap-4 overflow-y-auto py-6 xl:py-12">
      ...
      <div className="flex items-center gap-8 text-gray-500">
        <div>
          更新日期：<strong>2023/6/6</strong>
        </div>
        <div>
          生效日期：<strong>2023/6/6</strong>
        </div>
      </div>
      ...
      <div>
        ...
        <p>
          如对本《隐私政策》或相关事宜有任何问题，请通过 <strong>hello@yike.xyz</strong> 与我们联系。
        </p>
      </div>
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            <strong>日志信息</strong>，指您使用我们的服务时，系统可能通过cookies、标识符及相关技术收集的信息，包括您的
            <strong>设备信息</strong>、<strong>浏览信息</strong>、<strong>点击信息</strong>
