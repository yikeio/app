...
export default function HomeBrowserSupport() {
  return (
    <div
      id="browser-support"
      className="flex flex-col gap-4 rounded-xl border-2 border-primary p-6 lg:flex-row lg:items-center lg:justify-between lg:p-12"
    >
