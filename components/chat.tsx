...
export function Chat(props: {
  ...
  const MessageBody = ({ message, index}: { message: RenderMessage; index: number;}) => {
    ...
    <div className="flex flex-col flex-1 max-h-screen overflow-y-auto bg-slate-100">
      ...
      <div className="sticky bottom-0 p-6">
        <div className="relative flex flex-col items-center gap-2 md:flex-row">
          <textarea
            ref={inputRef}
            className="flex-1 w-full py-4 px-4 md:py-2 md:pr-32 rounded-xl ring-0 focus:ring-0"
          ...
          />
          <button
            className="md:absolute flex items-center rounded-md gap-2 right-4 w-full h-fit px-5 py-2 text-white border-blue-600 bg-blue-700 md:-ml-32 md:w-fit hover:bg-blue-800 focus:ring-2 focus:ring-blue-500 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
